...
export const translations = {
  en: {
    ...
    title: 'AI Restro 360 — restaurant & hospitality tech',
    /** Home `<title>`, Open Graph, and landing `<h1>`. */
    seoHeroH1: 'AI Restro 360 — restaurant & hospitality tech',
    subtitle: 'Insights, tools, and platform updates for modern restaurants and food service teams.',
