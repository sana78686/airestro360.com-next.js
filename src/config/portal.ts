/**
 * Portal (panel) URLs. Override with NEXT_PUBLIC_PORTAL_BASE_URL when the panel host differs.
 */
const rawBase = String(
  typeof process !== 'undefined' && process.env.NEXT_PUBLIC_PORTAL_BASE_URL
    ? process.env.NEXT_PUBLIC_PORTAL_BASE_URL
    : 'https://portal.airestro360.com',
).replace(/\/+$/, '')

export const PORTAL_BASE_URL = rawBase
